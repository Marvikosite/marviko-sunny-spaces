...
const reviews = [
  ...
  },
  {
    ...
    date: "2025",
    text: "Выражаю благодарность директору «Марвико» Кочеву А.А. и нач. производства Кочеву С.А. за профессионалов, которые изготавливали и устанавливали нам пластиковые окна и двери; менеджерам Иванцовой А. и Бобровской Е. за дизайнерский подход по оформлению пластиковых дверей. Отдельно благодарю монтажника Грибовича В. за его «золотые руки» и мастера своего дела. Работники тактичные, вежливые, заслуживают доверия. На заданный вопрос дают профессиональный ответ. Всё сделано в срок и качественно. Здоровья вам, мира, добра и всех благ!",
    rating: 5,
